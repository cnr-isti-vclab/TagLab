...
class ISTrainer(object):
    ...
    def batch_forward(self, batch_data, validation=False):
        ...
        with torch.set_grad_enabled(not validation):
            ...
            #our version with dexter
            # dexter_mask = batch_data['dexter_mask']
            # prev_output = dexter_mask.to(torch.float32)
            ...
            # self.save_visualization(batch_data, output, counter, prefix='train')
            # counter= counter+1
