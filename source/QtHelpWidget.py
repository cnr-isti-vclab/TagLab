...
class QtHelpWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.gridlayout2.addWidget(QLabel("Confirm"), 9,0)
        self.gridlayout2.addWidget(QLabel("Reset"), 10,0)
        ...
        self.gridlayout2.addWidget(QLabel("<b>SPACE</b>"), 9, 1)
        self.gridlayout2.addWidget(QLabel("<b>ESC</b>"), 10, 1)
        ...
        self.gridlayout3.addWidget(QLabel("Delete"), 1, 0)
        self.gridlayout3.addWidget(QLabel("Merge"), 2, 0)
        self.gridlayout3.addWidget(QLabel("Divide"), 3, 0)
        self.gridlayout3.addWidget(QLabel("Subtract"), 4, 0)
        self.gridlayout3.addWidget(QLabel("Refine Border"), 5,0)
        self.gridlayout3.addWidget(QLabel("Refine Border - expand"), 6, 0)
        self.gridlayout3.addWidget(QLabel("Refine Border - contract"), 7, 0)
        self.gridlayout3.addWidget(QLabel("<b>A</b>"), 0, 1)
        self.gridlayout3.addWidget(QLabel("<b>DEL</b>"), 1, 1)
        self.gridlayout3.addWidget(QLabel("<b>M</b>"), 2, 1)
        self.gridlayout3.addWidget(QLabel("<b>D</b>"), 3, 1)
        self.gridlayout3.addWidget(QLabel("<b>S</b>"), 4, 1)
        self.gridlayout3.addWidget(QLabel("<b>R</b>"), 5, 1)
        self.gridlayout3.addWidget(QLabel("<b>+</b>"), 6, 1)
