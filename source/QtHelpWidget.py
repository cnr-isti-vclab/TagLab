...
class QtHelpWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.gridlayout2.addWidget(QLabel("Active Assign Tool"), 3, 0)
        self.gridlayout2.addWidget(QLabel("Active Edit Border Tool"), 4, 0)
        self.gridlayout2.addWidget(QLabel("Active Cut Tool"), 5, 0)
        self.gridlayout2.addWidget(QLabel("Active Crack Tool"), 6, 0)
        ...
        self.gridlayout3.addWidget(QLabel("Dilate Border"), 7, 0)
        self.gridlayout3.addWidget(QLabel("Erode Border"), 8, 0)
